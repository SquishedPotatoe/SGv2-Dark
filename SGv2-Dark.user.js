...
function addCss() {
  var css = `/* SGv2 Dark v1.5.9  2020-02-29 */
:root {
...
#content #charts h2.center, #content .sidebar__navigation:last-of-type + div, .is-hidden, img[title*="Extended Steamgifts"] {
    display: none;
}
...
form[method="post"] .form__rows .form__row + .form__submit-button, [key*="esg"] + .form__submit-button {
    margin-bottom: 20px;
}
...
.form__sync-data > .notification--warning {
    margin-right: 5px;
}
.form__screenshot {
...
.notification--success.notification--margin-top-small {
    margin-right: 0;
}
.notification.green {
    margin-right: 0;
...
.page__inner-wrap--narrow .page__heading + .notification--success {
    margin: 5px 0 -3px;
}
...
.icon-blue, .icon_to_clipboard, .dropdown_btn i.blue, .sidebar__shortcut__whitelist.esgst-whitelist, .esgst-whitelist, .sg-icon-blue, .esgst-header-menu-row i.blue, .tooltip_row i[style*="color: #84cfda"], .icon-navy {
...
.header_search > div > div > div:last-child:active, .header_search > div > div > div:last-child:active, .sidebar__shortcut-inner-wrap > *:not(.is-disabled):active, .sidebar__entry-loading:not(.is-disabled):active, .comment__submit-button:not(.is-disabled):active, .page__description__save:not(.is-disabled):active, .poll__vote-button:not(.is-disabled):active, .form__add-answer-button:not(.is-disabled):active, .form__sync-loading:not(.is-disabled):active, .btn_action:active:not(.is_saving):not(.is_disabled), .sidebar__entry-insert:not(.is-disabled):active, .sidebar__action-button:not(.is-disabled):active, .nav__sits:not(.is-disabled):active, .form__submit-button:not(.is-disabled):active, .form__sync-default:not(.is-disabled):active, .featured__action-button:not(.is-disabled):active, .sidebar__entry-delete:active, #content #gaurl a:active, #content .manageGa a:active, #content .showBundledDeals:active, #content button[type="submit"]:active, #content #activated_send:active, #content #real_cv_send:active, #content #multiple_wins_send:active, #content #giveaway_Create:active, #content .back-guide a:active, #content .gaButton:active, #content #giveaway_filters_Update:active, .sp-container button:active, .esgst-sm-colors-default:active, .view_key_btn:active, .esgst-sgpb-button:active, #DTEP_SteamApiKey + input:active, .show-hide-giveaway-list.small-colored:active, #dlg-body .RC-button:active, #dlg-body .RCE-button:active, #SGLCdlg-body .SGLCdlg-button:not(#SGLCdlg-progress):active, .esgst-chfl-panel i:active, .table__column__key__redeem:active {
...
.page_inner_wrap, .header_inner_wrap, .footer_inner_wrap {
    min-width: 1075px;
    max-width: 1075px;
}
.EGBDescriptionPopup {
...
.sidebar__navigation:last-of-type + div:not(.floating-pagination):not(.sidebar__mpu):not(.sidebar__subscribed) {
    background-color: var(--SGSP-sidebar-bg-color);
...
.sidebar__navigation:last-of-type + div > div {
    text-indent: 10px;
}
...
.widget-container.esgst-adots .table {
    min-height: 279px;
}
.esgst-gv-view {
...
.esgst-gv-icons > *:not(.esgst-button-set) {
    border: none!important;
...
.esgst-gv-icons > *:last-child, .esgst-gv-icons > *:last-child > .btn_action, .esgst-gv-icons > *:last-child > .sidebar__error, .esgst-gv-icons > .esgst-ge-sgt-button:last-child > .form__submit-button {
...
.sidebar .table.esgst-adots .table__row-outer-wrap {
...
.sidebar .esgst-adots .table__row-outer-wrap:first-of-type {
    margin-top: -3px;
}
...
.esgst-cl_gc-popout .table, .esgst-ggl-popout .table, .esgst-cl_ge-popout .table {
    border-top: 1px solid var(--SGSP-separator-light-color);
    box-shadow: 0 -1px 0 var(--SGSP-separator-dark-color);
}
...
.esgst-page-heading > *:not(.esgst-sttb-button):not(.esgst-stbb-button) {
    background-image: var(--SGSP-pageheading-bg-color)!important;
    border-color: var(--SGSP-pageheading-border-color)!important;
    color: var(--SGSP-pageheading-txt-color)!important;
}
...
.esgst-popup input[type="file"], .esgst-tab-menu input[type="file"], .esgst-form-row + input[type="file"] {
    background-color: transparent;
    border: none!important;
    color: hsl(0, 0%, 42%)!important;
    padding: 5px 2px;
}
.esgst-popup input[type="file"]::-webkit-file-upload-button, .esgst-tab-menu input[type="file"]::-webkit-file-upload-button, .esgst-form-row + input[type="file"]::-webkit-file-upload-button {
    background-image: var(--SGSP-silver-buttons-bg-color)!important;
    border: 1px solid hsla(0, 0%, 0%, 0.9)!important;
    border-color: var(--SGSP-silver-buttons-border-color)!important;
    border-radius: 4px;
...
.esgst-popup input[type="file"]::-webkit-file-upload-button:hover, .esgst-tab-menu input[type="file"]::-webkit-file-upload-button:hover {
    filter: var(--SGSP-button-hover-brightness);
}
.esgst-popup input[type="file"]::-webkit-file-upload-button:active, .esgst-tab-menu input[type="file"]::-webkit-file-upload-button:active {
    border-color: hsla(0, 0%, 0%, 0.75) hsla(0, 0%, 55%, 0.5) hsla(0, 0%, 55%, 0.5) hsla(0, 0%, 0%, 0.75)!important;
    border: 1px solid;
    box-shadow: 2px 2px 2px hsla(0, 0%, 0%, 0.5) inset, 7px 7px 10px hsla(0, 0%, 5%, 0.5) inset!important;
    margin-top: 0;
...
.esgst-gv-view .esgst-es-page-divisor {
    margin: 5px 0;
}
...
.comments > .esgst-es-page-divisor:first-of-type > .page__heading__breadcrumbs.page_heading_breadcrumbs {
    border-top: none;
    border-top-left-radius: 4px;
    border-top-right-radius: 4px;
    margin: -4px 0px 0;
...
.esgst-gv-icons .btn_action > i, .esgst-gv-icons .sidebar__error > i {
    display: block;
    line-height: 16px;
}
...
.esgst-gv-icons .esgst-elgb-button .btn_action > span, .esgst-gv-icons .esgst-elgb-button .sidebar__error > span, .esgst-gv-icons .esgst-gwc > i, .esgst-gv-icons .esgst-gwr > i, .esgst-gv-icons .esgst-gptw > i, .esgst-gc-panel:empty, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id].esgst-gc, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id] .btn_action, .esgst-gv-popout .esgst-giveaway-panel:empty, .esgst-gv-icons .esgst-gc, .esgst-gv-icons .esgst-gc-genres, .comments:empty {
    display: none;
}
...
.giveaway__heading > .esgst-mm-checkbox, .giveaway__row-inner-wrap > .esgst-mm-checkbox {
    vertical-align: middle;
}
...
.giveaway__heading [data-draggable-id="hideGame"], .giveaway__heading [data-draggable-id="egh"], [data-draggable-id].esgst-gf-hide-button i, [data-draggable-id].esgst-gf-unhide-button i, [data-draggable-id].esgst-gb-button i {
    opacity: 0.55;
}
...
.esgst-gv-popout .giveaway__heading > [data-draggable-id], .giveaway__heading > [data-draggable-id] {
    display: inline-block;
    line-height: 16px;
    vertical-align: middle;
}
.esgst-gv-popout .giveaway__heading [data-draggable-id]:not(.esgst-gc) i {
    vertical-align: baseline;
    width: 12px;
}
.esgst-gv-popout .giveaway__heading [data-draggable-id] i, .esgst-gv-popout .giveaway__heading [data-draggable-id="hideGame"], .esgst-gv-popout .esgst-gv-creator [data-draggable-id] i, .esgst-gv-popout .esgst-gv-creator [data-draggable-id="hideGame"] {
    font-size: 12px;
    text-shadow: var(--SGSP-ts-69);
}
...
.esgst-gc-panel [data-draggable-id] {
    vertical-align: middle;
}
...
.esgst-giveaway-links [data-draggable-id] .btn_action, .esgst-giveaway-links [data-draggable-id] .btn_action:hover, .esgst-giveaway-links [data-draggable-id] .btn_action:active {
    background: none!important;
    border: none!important;
    box-shadow: none!important;
    font-size: 13px;
...
.esgst-giveaway-links .btn_action.green span, .esgst-giveaway-links .btn_action.green i {
    color: var(--SGSP-green-icons-txt-color)!important;
}
.esgst-giveaway-links .btn_action.yellow span, .esgst-giveaway-links .btn_action.yellow i {
    color: var(--SGSP-yellow-icons-txt-color)!important;
}
.esgst-giveaway-links .btn_action.red span, .esgst-giveaway-links .btn_action.red i {
    color: var(--SGSP-red-icons-txt-color)!important;
}
...
.esgst-popup-layer .page__heading ~ div:not(.sidebar__search-container):not(.esgst-ugd-table), .esgst-sync-options > .form__rows, .esgst-settings-menu-feature .form__rows {
    background-color: unset!important;
    background-image: none;
    border: none!important;
    box-shadow: none!important;
...
.esgst-gv-popout .giveaway__heading > [data-draggable-id]:not(:first-child):not([data-draggable-id="ggl"]):not([data-draggable-id="name"]) {
...
.esgst-gv-box.is-faded:not(:hover) .esgst-gv-popout, .esgst-fs::-webkit-scrollbar, .sidebar .esgst-adots::-webkit-scrollbar {
    display: none;
}
.esgst-gv-box.is-faded:not(:hover) .esgst-gv-popout, .esgst-fs::-webkit-scrollbar, .sidebar .esgst-adots {
...
.esgst-tds-sidebar-item .sidebar__navigation__item__underline {
    margin-right: 18px;
}
...
.page__heading ~ div:not(.comments):not(.esgst-rbot):not(.esgst-popup-actions):not(.esgst-fmph), .page_heading ~ div:not(.comments):not(.esgst-rbot):not(.esgst-fmph), .pinned-giveaways__outer-wrap {
    will-change: transform;
}
.page__heading ~ div:hover:not(.sg2o-gridview-container), .page_heading ~ div:hover, .pinned-giveaways__outer-wrap:hover {
...
body .esgst-gv-icons .giveaway__column--contributor-level--positive:not(.esgst-glh-highlight) {
    background-color: hsl(92, 30%, 26%)!important;
}
body .esgst-gv-icons .giveaway__column--contributor-level--negative:not(.esgst-glh-highlight) {
    background-color: hsl(0, 60%, 35%)!important;
}
body .esgst-gv-icons .esgst-elgb-button {
    background-image: var(--SGSP-green-buttons-bg-color)!important;
}
.esgst-gv-icons > *:not(.esgst-button-set), .esgst-gv-icons .btn_action, .esgst-gv-icons .sidebar__error, .esgst-gv-icons .esgst-ge-sgt-button > .form__submit-button {
    box-shadow: 0 -1px 0 0 hsla(60, 1%, 60%, 1), -1px 0 0 0 hsla(60, 1%, 58%, 1), 0 1px 0 0 hsla(60, 1%, 37%, 1), 1px 0 0 0 hsla(60, 1%, 58%, 1)!important;
}
...
.esgst-sync-options .form__row__indent > .esgst-button-group {
    margin: 10px 0;
}
.widget-container > [data-esgst-popup].esgst-menu-layer .esgst-settings-menu {
    margin-top: -18px;
}
.widget-container > [data-esgst-popup] > .page__heading + div:not(.esgst-menu-split), .esgst-sync-area {
    margin-top: 10px!important;
}
.widget-container > [data-esgst-popup] .SMFeatures > .esgst-button-group {
    margin-bottom: 10px;
}
...
.widget-container > [data-esgst-popup] .page__heading > .page__heading__breadcrumbs {
    margin-right: 0;
}
...
.esgst-sync-frequency, .esgst-steam-api-key, .esgst-popup select:not(.esgst-auto-sync), .esgst-cfh-popout input {
    padding: 5px 10px;
}
.esgst-sm-colors select {
    padding: 0!important;
