...
function addCss() {
  var css = `/* SGv2 Dark v1.6.1  2020-05-28 */
:root {
...
.esgst-gv-popout .giveaway__heading > [data-draggable-id], .giveaway__heading > [data-draggable-id], .esgst-gv-popout .giveaway__heading [data-lightbox-id] {
    display: inline-block;
    line-height: 15px;
    vertical-align: middle;
}
...
.esgst-gv-popout .giveaway__heading [data-draggable-id] i, .esgst-gv-popout .giveaway__heading [data-draggable-id="hideGame"], .esgst-gv-popout .esgst-gv-creator [data-draggable-id] i, .esgst-gv-popout .esgst-gv-creator [data-draggable-id="hideGame"], .esgst-gv-popout .giveaway__heading [data-lightbox-id] {
    font-size: 12px;
    text-shadow: var(--SGSP-ts-69);
}
...
.esgst-popup-layer .page__heading ~ div:not(.sidebar__search-container):not(.esgst-ugd-table), .esgst-popup-layer .page_heading ~ div:not(.sidebar__search-container), .esgst-sync-options > .form__rows, .esgst-settings-menu-feature .form__rows {
    background-color: unset!important;
    background-image: none;
    border: none!important;
    box-shadow: none!important;
...
.esgst-gv-popout .giveaway__heading > [data-draggable-id]:not(:first-child):not([data-draggable-id="ggl"]):not([data-draggable-id="name"]), .esgst-gv-popout .giveaway__heading [data-lightbox-id] {
