...
function addCss() {
  var css = `/* SGv2 Dark v1.6.4  2020-12-12 */
:root {
...
::-moz-selection {
    background: var(--SGSP-select-highlight-color);
...
.giveaway_box_action--peek:hover:not(.giveaway_box_action--disabled) {
    background-image: linear-gradient(#33393e 0%, #212528 100%) !important;
    filter: brightness(1.1);
}  
